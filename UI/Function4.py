# Form implementation generated from reading ui file 'Function4.ui'
#
...
"QScrollBar {height:0px;width:0px;}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -3738, 1032, 4520))
...
"max-height:5px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "留学分析"))
        self.label_6.setText(_translate("Form", "热力图"))
        self.label_7.setText(_translate("Form", "通过留学要素热力图进行初步分析"))
        self.label_5.setText(_translate("Form", "留学相关要素热力图分析\n"
"\n"
"最有可能影响留学的特征是GRE\n"
"平均绩点、TOEFL成绩\n"
"\n"
...
"自身意愿、是否有学术成就"))
        ...
        self.label_10.setText(_translate("Form", "由图表可以看出GRE成绩310和330的分值的学生居多"))
        ...
        self.label_20.setText(_translate("Form", "可以看出\n"
"通常学校越好，学生的绩点可能就越高"))
        self.label_21.setText(_translate("Form", "平均绩点越高，GRE分数越高\n"
"反映出两者的相关性很大"))
        self.s1.setText(_translate("Form", "TextLabel"))
        self.s2.setText(_translate("Form", "TextLabel"))
        self.label_24.setText(_translate("Form", "通常情况下\n"
"绩点越高的学生，其深造意向也越高"))
        self.label_25.setText(_translate("Form", "继续深造意愿强的学生，其GRE分数较高"))
        self.s3.setText(_translate("Form", "TextLabel"))
        self.s4.setText(_translate("Form", "TextLabel"))
        self.label_28.setText(_translate("Form", "可以看出\n"
"本科学校优秀的学生，其深造意愿一般也越强"))
        self.label_29.setText(_translate("Form", "TOEFL与GRE分数\n"
"两者都为出国留学很重要的指标\n"
"可以看到两者相关度很高"))
        ...
        self.label_16.setText(_translate("Form", "利用线性回归模型对学生深造概率进行预测\n"
"可以看到预测结果虽有一定偏差，但相对准确"))
        self.label_17.setText(_translate("Form", "利用随机森林分类模型继续预测，在训练数据集中表现优秀\n"
"在测试数据集中仍然保持了较高的准确度"))
    ...
    def plot(self):
        ...
        ihtmap = Heatmap.Draw_HeatMap(dfSA)
        isc = Score_Count.Draw_SA(dfSA)
        is1 = Relation.Relation_btw_UR_and_CGPA(dfSA)
        is2 = Relation.Relation_btw_GRE_and_CGPA(dfSA)
        is3 = Relation.Relation_btw_SOP_and_GPA(dfSA)
        is5 = Relation.Relation_btw_UR_and_Chance_of_Admit(dfSA)
        is4 = Relation.Relation_btw_GRE_and_SOP(dfSA)
        is6 = Relation.Relation_btw_GRE_and_TOEFL(dfSA)
        ilr = Linear_Regression.Linear_Regression(dfSA,'dSA')
        irf1 = Random_Forest_Classifier_Predict.Random_Forest_Classifier(dfSA,'dSA')
        irf2 = Random_Forest_Classifier_Predict.Random_Forest_Classifier(dfSA,'dSA1')
